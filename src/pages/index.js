      ...
      <header className={clsx("hero hero--primary hero-bg", styles.heroBanner)}>
        <div className="header-container container">
          ...
          <p className="hero-subtitle ob-subtitle">
            1Block.AI is an open source, cloud-native LLMOps platform that
            empowers LLM & generative AI applications innovation. It was built
            on the top of cutting-edge technologies like Kubernetes, Ray.io,
            LangChain, etc., and designed to be cloud and ML framework agnostic.
          </p>
